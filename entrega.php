        ...
        <div class="payment-main-wrapper">
            ...
            <div class="user-card-info-wrapper">
                ...
                <form class="credit-card-info">
                    <label for="card-number">Endereço</label>
                    ...
                    <div class="validity-and-sc">
                        <div class="validity">
                            <label for="card-validity">Número</label>
                            <input type="number" name="card-validity" id="card-validity" >
                        </div>
                        
                     
                        <div class="security-code">
                            <label for="card-security-code">Complemento</label>
                            <div class="card-security-code-input-and-icon">
                                <input type="text" name="card-security-code" id="card-security-code" >
                   ...
                   <div class="phone-and-birthday">
                    ...
                    <input type="button" value="Ir para o pagamento" id="finish-payment">
                    </div>
